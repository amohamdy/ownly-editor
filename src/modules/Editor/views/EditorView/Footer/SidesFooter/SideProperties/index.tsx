...
import { Box, Switch, Button, FormControl, FilledInput, TextField, Input, Divider } from '@mui/material';
...
function TextProperties() {
	...
	return (
		<Box display={'flex'} flexDirection={'row'} justifyContent={'flex-start'}>
			<Box mr={0.5} display={'flex'} flexDirection={'row'} alignItems={'center'} justifyContent={'center'}>
				<SectionOne />
			</Box>
		</Box>
	);
